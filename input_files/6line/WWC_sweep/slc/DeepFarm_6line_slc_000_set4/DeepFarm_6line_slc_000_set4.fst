...
---------------------- INPUT FILES --------------------------------------------- 
"ElastoDyn_DeepFarm_6line_slc_000_set4.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"InflowFile_DeepFarm_6line_slc_000_set4.dat"     InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"HydroDyn_DeepFarm_6line_slc_000_set4.dat"       HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"none"                 SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"MoorDyn_DeepFarm_6line_slc_000_set4.dat"       MooringFile     - Name of file containing mooring system input parameters (quoted string) 
