...
---------------------- INPUT FILES --------------------------------------------- 
"ElastoDyn_DeepFarm_6line_dlc61_180_set2.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"InflowFile_DeepFarm_6line_dlc61_180_set2.dat"     InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../../IEA-15-240-RWT/IEA-15-240-RWT_AeroDyn15.dat"  AeroFile     - Name of file containing aerodynamic input parameters (quoted string) 
"../IEA-15-240-RWT-UMaineSemi_ServoDyn1_parked.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"HydroDyn_DeepFarm_6line_dlc61_180_set2.dat"       HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"none"                 SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"MoorDyn_DeepFarm_6line_dlc61_180_set2.dat"       MooringFile     - Name of file containing mooring system input parameters (quoted string) 
