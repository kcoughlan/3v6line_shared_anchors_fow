...
0.04          DT              - Recommended module time step (s)
...
850                     WtrDpth     - Water depth (m)
0                      MSL2SWL     - Offset between still-water level and mean sea level (m) [positive upward]
---------------------- INPUT FILES --------------------------------------------- 
"ElastoDyn_DeepFarm_6line_dlc16_360_set5.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"InflowFile_DeepFarm_6line_dlc16_360_set5.dat"     InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../../IEA-15-240-RWT/IEA-15-240-RWT_AeroDyn15.dat"  AeroFile     - Name of file containing aerodynamic input parameters (quoted string) 
"../IEA-15-240-RWT-UMaineSemi_ServoDyn1_operating.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"HydroDyn_DeepFarm_6line_dlc16_360_set5.dat"       HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"none"                 SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"MoorDyn_DeepFarm_6line_dlc16_360_set5.dat"       MooringFile     - Name of file containing mooring system input parameters (quoted string) 
"none"                 IceFile         - Name of file containing ice input parameters (quoted string) 
---------------------- OUTPUT -------------------------------------------------- 
False                  SumPrint    - Print summary data to "<RootName>.sum" (flag) 
100.0                   SttsTime    - Amount of time between screen status messages (s) 
